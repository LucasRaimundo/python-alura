...
class Restaurante:
    ...
    def listar_restaurante(cls):
        print(f"{'Nome do Restaurante'.ljust(25)} | {'Categoria do Restaurante'.ljust(25)} | {'Avaliações'.ljust(25)} |{'Status'} ")
    ...
    @property
    def ativo(self):
        return 'Restaurante ativo' if self._ativo else 'Resaurante inativo'
